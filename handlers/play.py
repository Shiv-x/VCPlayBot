...
async def play(_, message: Message):
           ...
           for administrator in administrators:
                      if administrator == message.from_user.id:  
                          ...
                          try:
                              ...
                              #print(e)
                              await lel.edit(
                                  f"<b>🔴 Flood Wait Error 🔴 \nAssistant {user.first_name} tidak dapat bergabung dengan grup Anda karena banyaknya permintaan bergabung untuk musicwam! Pastikan pengguna tidak dibanned dalam grup."
                                  "\n\nAtau tambahkan secara manual chatt dulu @RI024 untuk bisa menambahkan bot ke Grup Anda dan coba lagi</b>",
                              )
                              pass
    try:
        chatdetails = await USER.get_chat(chid)
    ...
    try:
        ...
        await lel.edit("Lagu tidak bisa ditemukan karena ngantuk. Coba cari dengan judul dan nama yang benar bukan asal ketik")
        print(str(e))
        return
                      ...
                      if administrator == message_.from_user.id:  
                          ...
                          try:
                              ...
                              await lel.edit(
                                  ...
                                  "\n\nAtau tambahkan secara manual chatt dulu @RI024 agar bisa masuk Grup Anda dan coba lagi</b>",
                              )
                              pass
    try:
        chatdetails = await USER.get_chat(chid)
...
async def jiosaavn(client: Client, message_: Message):
    ...
    try:
        ...
        await res.edit(
            "Foundally Nothing !, Anda Harus mengulang kembali terimakasih."
        )
        print(str(e))
        is_playing = False
        return
    keyboard = InlineKeyboardMarkup(
         [   
             ...
             [
                    ...
                    InlineKeyboardButton(
                        "Owner Music wan", url="https://t.me/RI024"
                    )
                ],
             [       
               InlineKeyboardButton(
